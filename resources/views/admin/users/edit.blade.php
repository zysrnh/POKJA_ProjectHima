...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white border border-gray-300 p-6 sm:p-8 shadow-sm">
        <div class="border-b border-gray-200 pb-4 mb-6">
            <h3 class="text-base font-bold uppercase tracking-wide text-gray-900">Perbarui Informasi Admin</h3>
            <p class="text-xs text-gray-500 mt-1">Kosongkan kolom password jika Anda tidak ingin mengubah password.</p>
        </div>
        ...
        <form action="{{ route('admin.users.update', $admin->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                >
                <p class="text-[11px] text-gray-500 mt-1">Isi minimal 6 karakter jika ingin mengganti password admin ini.</p>
                @error('password')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
